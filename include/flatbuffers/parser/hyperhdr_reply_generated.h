...
inline ::flatbuffers::Offset<Reply> CreateReply(::flatbuffers::FlatBufferBuilder &_fbb, const ReplyT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  return Reply::Pack(_fbb, _o, _rehasher);
}
...
inline hyperhdrnet::Reply *GetMutableSizePrefixedReply(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<hyperhdrnet::Reply>(buf);
}

template <bool B = false>
inline bool VerifyReplyBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifyBuffer<hyperhdrnet::Reply>(nullptr);
}

template <bool B = false>
inline bool VerifySizePrefixedReplyBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<hyperhdrnet::Reply>(nullptr);
}
